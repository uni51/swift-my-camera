...
class EffectViewController: UIViewController {
    ...
    */
    ...
    @IBAction func effectButtonImage(_ sender: Any) {
        // エフェクト前画像をアンラップして、エフェクト用画像として取り出す
        if let image = originalImage {
            ...
            // フィルターの種類を引数で指定された種類を指定して、CIFilterのインスタンスを取得
